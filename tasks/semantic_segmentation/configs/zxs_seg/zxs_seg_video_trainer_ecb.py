...
model = dict(
    ...
    backbone=dict(
        ...
        expansion=[1, 3, 4, 4],
        conv_cfg=dict(type="ECBConv", expansion=1, norm_cfg=dict(type='BN')),
...
img_cfg = dict(enabled=True,
               ...
               resume_from='./tasks/semantic_segmentation/work_dirs/zxs_seg_video_trainer_ecb/latest.pth',
               load_from=None)
...
log_level = 'INFO'
work_dir = './tasks/semantic_segmentation/work_dirs/zxs_seg_video_trainer_ecb'
load_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 2)
