...
train_pipline = [
            ...
            dict(
                ...
                std=[128, 128, 128],
                to_rgb=True),
            dict(type='Pad', size=(352, 352), pad_val=0,
                 pad_keys=["gt_mask", "img", 'ori_img']),
...
log_level = 'INFO'
work_dir = './tasks/semantic_segmentation/work_dirs/zxs_seg_3c_'
load_from = None
