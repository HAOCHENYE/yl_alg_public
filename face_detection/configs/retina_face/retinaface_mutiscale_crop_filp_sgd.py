...
work_dir = './face_detection/work_dirs/retinaface_mutiscale_crop_filp_sgd'
load_from = None
resume_from = './face_detection/work_dirs/retinaface_mutiscale_crop_filp_sgd/latest.pth'
# resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 2)
